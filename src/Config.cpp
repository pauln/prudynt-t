...
Config::Config() {
    ...
    std::vector<ConfigItem<int>> intItems = {
        ...
        {"stream0.osd_pos_time_x", stream0osdPosTimeX, 15, [](const int &v) { return v >= 0; }, "X position for OSD in stream 0"},
        {"stream0.osd_pos_time_y", stream0osdPosTimeY, 10, [](const int &v) { return v >= 0; }, "Y position for OSD in stream 0"},
        ...
        {"stream0.osd_logo_transparency", stream0osdLogoAlpha, 255, [](const int &v) { return v >= 0; }, "Transparency for logo OSD in stream 0"},
